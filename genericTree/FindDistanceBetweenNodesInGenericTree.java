...
public class FindDistanceBetweenNodesInGenericTree {
    ...
    public static int findDistanceBetweenNodes(Node node, int val1, int val2) {
    ...
    public static void main(String[] args) {
        ...
        ;
        // display(root);
        System.out.println(findDistanceBetweenNodes(root, 120, 100));
    }
}
